...
While each Aethyr represents one Sephira in one of the four (three of four) worlds, it should also be remembered that each sphere in each world contains a complete tree within itself, making 400 spheres total (10 Micro-Sephirah x 10 Macro-Sephirah x 4 worlds). This is my addition to Eshelman's mapping, above, and I find it works perfectly elegantly. Each Aethyr only partially partakes of the nature of its attributed sphere, but each contain a blizzard of Qabalistic symbolism, often mapping multiple paths and spheres and progressions from "station to station" on the tree. This makes perfect sense if you understand each Aethyr as subsuming *all ten* sephira within its respective sphere and world. I should also note that simply to include one sphere or path, or a combination of spheres and paths, automatically *implies* the rest of the tree, even if only a few spheres or paths make an explicit appearance. This also suggests that there is far, far more to be seen and explored in each aethyr, unless the additional micro-spheres and micro-paths stay silent and inactive in each Aethyr, resisting exploration. Although there is no real reason why this should be, or why each sphere and path could be explicitly explored with repeated callings of an Aethyr, perhaps refined and honed with traditional Qabalistic pathworkings (using pentagram and hexagram rituals along with 777 correspondences) while *within* each Aethyr. This is all theoretical as of yet.

<center><img src="http://orig02.deviantart.net/6c50/f/2009/044/9/5/tree_of_life_in_4_worlds_by_freemasons.jpg"></center>
